...
def save_progress_snapshot(profile: dict):
    ...
    Mỗi dòng là một bản ghi: student_email, timestamp, kỹ năng, embedding.
    """
    snapshot = {
    ...
    print(f"📊 Đã ghi snapshot tiến bộ cho học sinh {profile['student_email']}.")

def get_student_progress(student_email: str) -> list[dict]:
    """
    ...
    with open(PROGRESS_FILE, "r", encoding="utf-8") as f:
        for line in f:
            try:
                ...
                if record.get("student_email") == student_email:
